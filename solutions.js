...
let firstAdPic = firstAd.getElementsByTagName('img')[0]
firstAdPic.setAttribute('src', 'http://placebear.com/200/300')
// Exercise 8): Find Sam's post and change its text to something incredible.
document.getElementsByTagName('p')[4].innerHTML = "I am incredible"

// Exercise 9): Find the first post and add the `.post-liked` class to it, and watch it turn blue.
let turnblue = document.getElementsByClassName('media-body')[1];
let firstPost = turnblue.getElementsByTagName('p')[0]
...
let turnred = document.getElementsByClassName('inline-list post-actions')[0];
let secondPost = turnred.getElementsByTagName('li')[2]
